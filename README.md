...
<p align="center">
  ...
  <img src="https://komarev.com/ghpvc/?username=shankarkakumani&style=for-the-badge&color=3DDC84" alt="Profile Views"/>
</p>
...
```kotlin
object ShankarKakumani {
    val name = "Shankar Kakumani"
    val role = "Android & Flutter Developer"
    val location = "India"

    val interests = listOf(
        "Real-time Communication (QUIC/WebRTC)",
        "Machine Learning",
        "Rust",
        "Cyber Security",
        "Music",
    ...
    fun sayHi() = println("Thanks for dropping by! Let's build something amazing together!")
}
```

- Building real-time communication libraries with QUIC/MoQ
- Creating ML inference tools for Flutter with Rust backends
- Publishing open source packages on pub.dev
...
- Building innovative Android & Flutter applications
- Exploring Jetpack Compose for modern Android UI
